  ...
  return (
    <>
      <div className="metric-row">
        <div className="metric-mini"><div className="metric-mini-label">Total Dispatchers</div><div className="metric-mini-value" style={{ color: 'var(--accent2)' }}>{items.length}</div></div>
        <div className="metric-mini"><div className="metric-mini-label">Avg Rev / Dispatcher</div><div className="metric-mini-value">{fmt(avgRev)}</div></div>
        <div className="metric-mini"><div className="metric-mini-label">Avg Loads</div><div className="metric-mini-value">{avgLoads}</div></div>
        <div className="metric-mini"><div className="metric-mini-label">Top Region</div><div className="metric-mini-value" style={{ fontSize: 13 }}>{topRegion}</div></div>
      </div>
      ...
      {confirmId && (
        <div className="modal-backdrop">
          <div className="modal" style={{ width: 360 }}>
            ...
            <p style={{ fontSize: 13, color: 'var(--muted)' }}>Are you sure? This cannot be undone.</p>
            <div className="modal-footer">
